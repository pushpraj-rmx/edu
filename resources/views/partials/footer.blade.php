                    ...
                    <ul class="space-y-2 text-sm">
                        ...
                        @if(!empty($footer['contact']['phone']))
                            <li class="flex items-center">
                                ...
                                <a href="tel:{{ $footer['contact']['phone'] }}" class="hover:text-white">{{ $footer['contact']['phone'] }}</a>
                            </li>
                        @endif
                        @if(!empty($footer['contact']['email']))
                            <li class="flex items-center">
                                ...
                                <a href="mailto:{{ $footer['contact']['email'] }}" class="hover:text-white">{{ $footer['contact']['email'] }}</a>
                            </li>
                        @endif
                    </ul>
                </div>
